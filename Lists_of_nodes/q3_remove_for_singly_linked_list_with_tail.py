"""
Implement a more general remove method that can remove list's nodes from any position.
To help in this task an insert method is also provided that works as an example on how this method has to be implemented.

The remove method will accept an index position of a node to be removed,
and it will return the value of the node being removed.

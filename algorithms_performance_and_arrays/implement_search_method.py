...
"""
The search method accepts a value to be searched in the array and returns the first index position where
 the value is found or -1 is the value is not found the array
"""

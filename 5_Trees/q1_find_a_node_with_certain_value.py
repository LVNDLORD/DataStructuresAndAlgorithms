...
Given a basic BST structure (included), add a _find() method to it, to search for values in the tree.
The basic definition of the method is already included.
Start from the root node and move to the appropriate nodes searching for the wanted value.
The method should return the node that holds the value or None if the value is not found.
...
tree.insert(30)
tree.insert(35)
print(tree._find(20))  # 20<10<><>#><40<30<><35<><>#>#><>#>#
